...
(function () {
  ...
  /* ---------- Grouped-button mode nav, mirroring Novos' 08.2 pattern
     ...
     (labs/simuladores-navigation-lab.css), mirroring the identical
     change just made in simulador-novos.js -- independent copy, same
     as every prior nav change to this file. Label span + chevron are
     purely additive (0 change to .textContent, 0 renamed class,
     data-mode untouched), so pre-existing tests that click
     '.smModeBtn[data-mode="..."]' or read .smModeGroupLabel/
     .smModeBtn.textContent keep working unmodified. ---------- */
  function modeGroups() {
    var groups = {}, order = [];
